...
- [Microsoft MarkItDown 0.1.6](https://github.com/microsoft/markitdown) — 수정하지 않은 변환
  엔진, MIT License.
- [Qt for Python / PySide6 및 Shiboken6 6.11.1](https://doc.qt.io/qtforpython-6/) — 수정하지
  않은 GUI 런타임, LGPLv3.
- [Python 3.12](https://docs.python.org/3.12/license.html) — 앱에 포함된 인터프리터, PSF
  License Version 2.
- [PyInstaller 6.21.0](https://github.com/pyinstaller/pyinstaller) — 패키징 도구와 포함된
  bootloader, Bootloader Exception이 적용된 GPL-2.0-or-later. run-time hook은 Apache-2.0.

DMG의 `Third-Party-Licenses/`에는 배포되는 모든 구성요소의 버전 목록, 원본 프로젝트 링크와
개별 라이선스 파일이 포함됩니다. 강아지·뼈다귀·해·달은 직접 그린 QPainter 벡터이며 제3자
이미지나 폰트 파일을 사용하지 않습니다.
